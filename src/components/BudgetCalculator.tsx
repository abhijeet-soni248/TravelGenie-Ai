...
export function BudgetCalculator() {
  ...
  const baseAccommodation = accommodationRates[accommodation as keyof typeof accommodationRates] || 3500;
  const baseTransport = transportRates[transport as keyof typeof transportRates] || 1200;
